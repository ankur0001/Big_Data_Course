...
public class Assignment_6_2{
	public static class Mapperr extends Mapper<LongWritable,Text,Text,IntWritable>{
		public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException{
			...
			if(fields[2].equals("India")){
				context.write(new Text(fields[3]),new IntWritable(new Integer(Integer.parseInt(fields[9]))));
			}
		}
	}
	...
	public static void main(String[] args) throws IllegalArgumentException, IOException, ClassNotFoundException, InterruptedException {
		...
		Job job=new Job(conf,"ACADGILD Assignment_6_2");
		job.setJarByClass(Assignment_6_2.class);
		job.setMapperClass(Assignment_6_2.Mapperr.class);
		job.setReducerClass(Assignment_6_2.Reducerr.class);
